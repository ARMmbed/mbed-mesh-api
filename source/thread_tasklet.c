...
#define CONFIGURED_INTERFACE_NAME   "6L_THREAD"
...
/* Tasklet data */
static tasklet_data_str_t *thread_tasklet_data_ptr = NULL;
...
void thread_tasklet_configure_network(void)
{
    ...
    thread_tasklet_data_ptr->link_config.rfChannel = 19;
    thread_tasklet_data_ptr->channel_list = 1<<19;
...
int8_t thread_tasklet_connect(mesh_interface_cb callback, int8_t nwk_interface_id)
{
    ...
    memset(thread_tasklet_data_ptr, 0, sizeof(tasklet_data_str_t));
...
void thread_tasklet_init()
{
    ...
    {
        thread_tasklet_data_ptr = ns_dyn_mem_alloc(sizeof(tasklet_data_str_t));
