...
#ifdef  YOTTA_CFG_MBED_OS_NANOSTACK_SCAN_CHANNEL_LIST
// use mbed OS configuration if it is available
#define SCAN_CHANNEL_LIST   YOTTA_CFG_MBED_OS_NANOSTACK_SCAN_CHANNEL_LIST
#else
 ...
 */
#ifdef YOTTA_CFG_MBED_OS_NANOSTACK_CHANNEL_PAGE
// use mbed OS configuration if it is available
#define FHSS_CHANNEL_PAGE   YOTTA_CFG_MBED_OS_NANOSTACK_CHANNEL_PAGE
#else
 ...
 */
#ifdef YOTTA_CFG_MBED_OS_NANOSTACK_THREAD_CHANNEL
#define THREAD_RF_CHANNEL   YOTTA_CFG_MBED_OS_NANOSTACK_THREAD_CHANNEL
#else
